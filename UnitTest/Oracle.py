...
class Test:
	...
	def passed(self):
		print self.name +"(execution time "+str(self.time_elapsed.microseconds)+"ms) : " + '\033[92m'+"PASS!"+'\033[0m'
		self.result = True

	def failed(self):
		print self.name+"(execution time: "+str(self.time_elapsed.microseconds)+"ms) : "+ '\033[91m'+"FAIL!"+'\033[0m'
		self.result = False
